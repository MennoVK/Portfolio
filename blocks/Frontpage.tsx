        ...
        <section className="w-full h-screen">
            <div className="absolute h-full p-20 uppercase">
                ...
                <p className="absolute bottom-20 text-12">
                    Scroll down
                    <Image src="/svgs/arrow-down.svg" alt="arrow down" width={16} height={9} className="inline mx-10 align-baseline"/>
                </p>
            </div>
            <Image src="/shader.gif" alt="home" width={1440} height={900} className="object-cover w-full h-full" />
        </section>
    )
}