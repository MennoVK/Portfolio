...
const button = tv({
    base: "mdlg:flex-grow text-center border border-white/40 mdlg:basis-0 text-12 px-10 backdrop-blur-mdlg mdlg:hover:backdrop-blur-lg transition-all duration-300",
    variants: {
        rounded: {
